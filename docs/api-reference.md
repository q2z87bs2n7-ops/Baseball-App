...
| `/teams/{id}/roster` | ✅ | `?rosterType=40Man` includes IL players. Stats v2 splits roster as `hitting = position.abbreviation !== 'P'` (TWP players are in BOTH lists), `pitching = 'P' || 'TWP'`. |
