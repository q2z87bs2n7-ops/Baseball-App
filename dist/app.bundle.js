(() => {
  ...
  var Recorder = {
    ...
    _mergePitchEnvelope: function(gamePk, envelope) {
      ...
      var existing = arr.findIndex(function(e) {
    ...
    _updateStatus: function() {
      ...
      var elapsedMs = Recorder.active ? tsNow() - Recorder.startedAt : Recorder.data.metadata && Recorder.data.metadata.durationMs || 0;
      var mins = Math.floor(elapsedMs / 6e4);
      var secs = Math.floor(elapsedMs % 6e4 / 1e3);
