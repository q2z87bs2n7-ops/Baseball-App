(() => {
  ...
  function genBasesLoaded() {
    ...
    Object.values(state.gameStates).forEach(function(g) {
      ...
      var sub = g.awayAbbr + " " + g.awayScore + ", " + g.homeAbbr + " " + g.homeScore + " \xB7 " + ordinal(g.inning);
  ...
  function renderEmptyState(postSlate, intermission) {
    ...
    var labelText = intermission ? "NEXT UP &middot; " + n + (n === 1 ? " GAME REMAINING" : " GAMES REMAINING") : n + (n === 1 ? " UPCOMING GAME" : " UPCOMING GAMES");
    ...
    var hypeBlock = intermission ? "" : '<div class="empty-hype-block"><button class="demo-cta" onclick="toggleDemoMode()">' + (state.demoMode ? "\u23F9 Exit Demo" : "\u25B6 Try Demo") + '</button><div class="empty-hype-headline">' + greeting.headline + "</div>" + hypeRecapCta + '<div class="empty-hype-pills"><span class="hype-pill hr">\u{1F4A5} Home Runs</span><span class="hype-pill scoring">\u{1F7E2} Scoring Plays</span><span class="hype-pill risp">\u26A1 RISP</span></div><div class="empty-hype-sub">Play-by-play from every MLB game surfaces here the moment a game starts.</div></div>';
  ...
  var MLB_TEAM_RADIO = {
    ...
    109: { name: "KTAR 620 AM", url: "https://playerservices.streamtheworld.com/api/livestream-redirect/KTARAMAAC.aac", format: "hls" },
    110: { name: "WBAL 1090 AM", url: "https://playerservices.streamtheworld.com/api/livestream-redirect/WBALAMAAC.aac", format: "hls" },
    ...
    113: { name: "700 WLW", url: "https://playerservices.streamtheworld.com/api/livestream-redirect/WLWAMAAC.aac", format: "hls" },
    114: { name: "WTAM 1100 AM", url: "https://stream.revma.ihrhls.com/zc1749/hls.m3u8", format: "hls" },
    115: { name: "KOA 850 / 94.1", url: "https://playerservices.streamtheworld.com/api/livestream-redirect/KOAAMAAC.aac", format: "hls" },
    ...
    118: { name: "96.5 The Fan KFNZ", url: "https://playerservices.streamtheworld.com/api/livestream-redirect/KFNZFMAAC.aac", format: "hls" },
    119: { name: "KLAC AM 570 LA Sports", url: "https://playerservices.streamtheworld.com/api/livestream-redirect/KLACAMAAC.aac", format: "hls" },
    ...
    133: { name: "KSTE 650 AM Sacramento", url: "https://playerservices.streamtheworld.com/api/livestream-redirect/KSTEAMAAC.aac", format: "hls" },
    ...
    137: { name: "KNBR 104.5 / 680", url: "https://playerservices.streamtheworld.com/api/livestream-redirect/KNBRAMAAC.aac", format: "hls" },
    138: { name: "KMOX NewsRadio 1120", url: "https://live.amperwave.net/manifest/audacy-kmoxamaac-llhlsc.m3u8", format: "hls" },
    139: { name: "WDAE 95.3 FM / 620 AM", url: "https://playerservices.streamtheworld.com/api/livestream-redirect/WDAEAMAAC.aac", format: "hls" },
    ...
    145: { name: "WMVP ESPN 1000 AM", url: "https://playerservices.streamtheworld.com/api/livestream-redirect/WMVPAMAAC.aac", format: "hls" },
    ...
    158: { name: "WTMJ Newsradio 620", url: "https://playerservices.streamtheworld.com/api/livestream-redirect/WTMJAMAAC.aac", format: "hls" }
  };
  ...
  function patchFeedItemWithClip(feedItemTs, gamePk, clip) {
    ...
    var thumbUrl = thumb ? forceHttps3(thumb) : "";
  ...
  function renderLogCapture() {
    ...
    list.innerHTML = rows.slice().reverse().map(function(e) {
      ...
      var tag = e.src ? '<span class="lv-tag">[' + escapeHtml3(e.src) + "]</span>" : "";
  ...
  function renderNetTrace() {
    ...
    list.innerHTML = devNetLog.slice().reverse().map(function(e) {
      ...
      var err = e.errorMsg ? '<div style="margin-left:24px;color:#ff6b6b">' + escapeHtml3(e.errorMsg) + "</div>" : "";
  ...
  function setSectionCallbacks(cb) {
  ...
  var leagueLeadersCache2 = { hitting: {}, pitching: {} };
  ...
  async function loadTodayGame() {
    ...
    try {
      ...
      if (liveGame) {
        document.getElementById("todayGame").innerHTML = sectionCallbacks.renderNextGame(liveGame, "TODAY");
  ...
  function renderMediaList() {
    ...
    mediaVideos.forEach(function(v) {
      ...
      var thumbUrl = v.thumb ? forceHttps4(v.thumb) : "";
  ...
  async function buildGameDetailPanel(g, gameNum) {
    ...
    if (highlightUrl) {
      ...
      if (thumbUrl) {
        ...
        html += '<img src="' + forceHttps4(thumbUrl) + `" loading="lazy" onerror="this.style.display='none'">`;
  ...
  function mkProxyNewsRow(item) {
    ...
    var thumb = isSafeNewsImage(item.image) ? '<div class="news-thumb' + sourceClass + '"><img src="' + escapeNewsHtml(forceHttps4(item.image)) + `" alt="" onerror="this.parentNode.innerHTML='<span class=&quot;news-thumb-placeholder&quot;>` + icon + `</span>'"></div>` : '<div class="news-thumb' + sourceClass + '"><span class="news-thumb-placeholder">' + icon + "</span></div>";
  ...
  async function loadLeagueLeaders() {
    ...
    try {
      ...
      leagueLeadersCache2[leagueLeaderTab] = leaderMap;
  ...
  function switchLeagueLeaderTab(tab, btn) {
    ...
    var cached = leagueLeadersCache2[tab], stats = tab === "hitting" ? LEAGUE_HIT_STATS : LEAGUE_PIT_STATS;
  ...
  function buildAndRenderYesterdayHeroes() {
    ...
    var tiles = heroes.map(function(h) {
      ...
      var heroUrl = h.imageUrl ? forceHttps5(h.imageUrl) : "";
  ...
  function renderHighlightStrip(items, gamePk) {
    ...
    var safeUrl = imgUrl ? forceHttps5(imgUrl) : "";
  ...
  async function loadPulseNews() {
    ...
    try {
      ...
      var d2 = await r2.json();
      var arts = (d2.articles || []).filter(function(a) {
        return a.headline;
  ...
  function renderPulseNewsCard() {
    ...
    if (article.image && isSafeNewsImage(article.image)) {
      var imgUrl = forceHttps6(article.image);
    ...
    var html = '<div style="padding:12px;display:flex;flex-direction:column;gap:8px">' + img + '<div style="font-size:.8rem;font-weight:600;color:var(--text);line-height:1.35">' + headline + "</div>" + (pubDate ? '<div style="font-size:.65rem;color:var(--muted)">' + fmtNewsDate(pubDate) + "</div>" : "") + "</div>";
  ...
  function capImgError(el, primary, secondary, letter) {
    el.onerror = null;
    var p = (primary || "#333").replace(/#/g, "%23"), s = (secondary || "#fff").replace(/#/g, "%23");
    el.src = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><circle cx="32" cy="32" r="30" fill="' + p + '"/><text x="32" y="41" text-anchor="middle" font-family="system-ui,sans-serif" font-size="28" font-weight="800" fill="' + s + '">' + letter + "</text></svg>";
  }
