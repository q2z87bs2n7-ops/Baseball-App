...
function mkProxyNewsRow(item){
  ...
  var link=item.link||'#';
  var title=normalizeNewsText(item.title||'');
  return '<div class="news-item">'+thumb+'<div class="news-body">'+kicker+'<div class="news-title"><a href="'+escapeNewsHtml(link)+'" target="_blank" rel="noopener">'+escapeNewsHtml(title)+'</a></div>'+(date?'<div class="news-meta">'+date+'</div>':'')+'</div></div>';
}
