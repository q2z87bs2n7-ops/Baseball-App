...
export const BASEBALL_BUZZ_ACCOUNTS = [
  ...
  { handle: 'jomboymedia.bsky.social',         name: 'Jomboy Media',        tag: 'Media',      category: 'league' },
  { handle: 'slangsonsports.bsky.social',      name: 'Sarah Langs',         tag: 'MLB.com',    category: 'league' },

  // National insiders
  { handle: 'jeffpasan.bsky.social',           name: 'Jeff Passan',         tag: 'ESPN',       category: 'insider' },
  ...
  { handle: 'feinsand.bsky.social',            name: 'Mark Feinsand',       tag: 'MLB.com',    category: 'insider' },
  ...
  { handle: 'chriskirschner.bsky.social',     name: 'Chris Kirschner',     tag: 'Yankees',    category: 'team' },
  ...
  { handle: 'kennlandry.bsky.social',         name: 'Kennedi Landry',      tag: 'Rangers',    category: 'team' },
  ...
  { handle: 'jordanmcpherson.bsky.social',    name: 'Jordan McPherson',    tag: 'Marlins',    category: 'team' },
  ...
  { handle: 'sahadevsharma.bsky.social',      name: 'Sahadev Sharma',      tag: 'Cubs',       category: 'team' },
  ...
  { handle: 'gdubmlb.bsky.social',            name: 'Gordon Wittenmyer',   tag: 'Reds',       category: 'team' },
  ...
  { handle: 'hardingmlb.bsky.social',         name: 'Thomas Harding',      tag: 'Rockies',    category: 'team' },
  ...
  { handle: 'vivaelbirdos.bsky.social',       name: 'Viva El Birdos',      tag: 'Cardinals',  category: 'team' },
