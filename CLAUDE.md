...
const STORY_ROTATE_MS=3000              // auto-advance every 3 seconds (was 10s pre-v2.42)
```
...
```javascript
const STORY_ROTATE_MS = 3_000;  // auto-advance every 3 seconds
