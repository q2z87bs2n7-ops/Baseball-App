...
| `setRadioUI(on, pick)` | Updates `#radioToggle` background colour, knob position, and `#radioStatusText` content. On: green knob right + "Playing · ABBR · Station Name" or "Playing · Fox Sports Radio". Off: bordered knob left + "Off · Auto-pairs to focus game". |
