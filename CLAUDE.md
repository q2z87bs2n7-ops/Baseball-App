...
**HR card badge logic (`getHRBadge`, v2.27.39):** Badge label is computed at the `pollGamePlays` call site using score/inning data and passed as optional 8th parameter `badgeText` to `showPlayerCard`. Priority order:
