...
- **Push API (`/api/*`)**: Vercel Hobby — `https://baseball-app-sigma.vercel.app` — **preview deployments disabled** (main branch only to avoid quota exhaustion)
