...
(function () {
  ...
  function pipRow(label, filled, total, accent) {
    ...
    return (
      '<div class="fc-pip-row" style="display:flex;align-items:center;gap:8px;">' +
        '<span style="font:600 10px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.14em;color:#9aa0a8;width:14px;">' + label + '</span>' +
  ...
  function bigPipRow(label, filled, total, accent, size) {
    ...
    return (
      '<div style="display:flex;align-items:center;justify-content:space-between;gap:14px;padding:10px 0;border-bottom:1px solid #1e2d4a;">' +
        '<span style="font:600 12px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.18em;color:#9aa0a8;">' + label + '</span>' +
    ...
    return (
      '<div style="display:flex;align-items:center;gap:8px;min-width:0;">' +
        '<span style="' +
          ...
          'letter-spacing:0.06em;color:#e8eaf0;' +
        '">' + esc(abbr) + '</span>' +
        '<span style="font:600 18px/1 ui-monospace,SFMono-Regular,Menlo,monospace;color:#e8eaf0;' +
  ...
  function renderPitchPill(pitch) {
    ...
    return (
      '<span class="fc-pitch-pill" title="' + titleAttr + '" style="' +
          ...
          'background:#0a0f1e;border:1px solid #1e2d4a;overflow:hidden;flex:0 0 auto;' +
        '">' +
        // left index column
        '<span style="' +
            'display:inline-flex;align-items:center;justify-content:center;' +
            'width:22px;background:#111827;color:#9aa0a8;' +
  ...
  function renderCard(data) {
    ...
    if (d.lastPitch) {
      ...
      lastPitchHtml =
        '<div style="padding:8px 12px;border-top:1px solid #1e2d4a;background:#0a0f1e;font:600 10px/1 ui-monospace,SFMono-Regular,Menlo,monospace;color:#9aa0a8;letter-spacing:0.1em;">' +
      ...
      '<div class="fc-card" style="' +
        ...
        '<div style="display:flex;align-items:center;gap:8px;padding:8px 12px 6px 12px;">' +
          '<span style="display:inline-flex;align-items:center;gap:5px;font:700 9px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.18em;color:#e03030;">' +
            ...
            'LIVE' +
          '</span>' +
          '<span style="font:600 9px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.14em;color:#9aa0a8;">' +
        ...
        '<div style="display:flex;align-items:center;justify-content:space-between;padding:0 12px 8px 12px;">' +
          ...
          '<span style="font:500 9px/1 ui-monospace,SFMono-Regular,Menlo,monospace;color:#3a4d75;letter-spacing:0.2em;">' + half + '</span>' +
          teamChip(d.homeAbbr, d.homePrimary || '#1e2d4a', d.homeScore, !awayBatting) +
        '</div>' +

        // Body grid: count pips + diamond
        '<div style="display:grid;grid-template-columns:1fr 56px;gap:10px;padding:8px 12px 10px 12px;border-top:1px solid #1e2d4a;background:#0c1426;">' +
        ...
        // Matchup row
        '<div style="display:flex;align-items:center;gap:8px;padding:8px 12px;border-top:1px solid #1e2d4a;">' +
          '<div style="display:flex;flex-direction:column;gap:2px;min-width:0;flex:1;">' +
            '<span style="font:600 8px/1 ui-monospace,SFMono-Regular,Menlo,monospace;color:#9aa0a8;letter-spacing:0.16em;">AB</span>' +
            '<span style="font:600 12px/1.1 ui-sans-serif,system-ui,sans-serif;color:#e8eaf0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">' +
              esc(d.currentBatterName || '—') +
            '</span>' +
          '</div>' +
          '<span style="font:500 10px/1 ui-monospace,SFMono-Regular,Menlo,monospace;color:#3a4d75;">vs</span>' +
          '<div style="display:flex;flex-direction:column;gap:2px;min-width:0;flex:1;align-items:flex-end;">' +
            '<span style="font:600 8px/1 ui-monospace,SFMono-Regular,Menlo,monospace;color:#9aa0a8;letter-spacing:0.16em;">PIT</span>' +
            '<span style="font:600 12px/1.1 ui-sans-serif,system-ui,sans-serif;color:#e8eaf0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:right;">' +
  ...
  function gameSwitchChip(g) {
    ...
    return (
      '<button type="button" onclick="setFocusGame && setFocusGame(' + (g.gamePk || 0) + ')" style="' +
          ...
          'border-radius:8px;border:1px solid ' + (focused ? '#3a4d75' : '#1e2d4a') + ';' +
          'background:' + (focused ? '#162039' : '#0a0f1e') + ';cursor:pointer;color:#e8eaf0;' +
          (focused ? 'box-shadow:0 0 0 1px #3a4d75 inset;' : '') +
        '">' +
        '<span style="font:700 10px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.06em;color:#9aa0a8;">' +
          esc(g.awayAbbr) + ' <span style="color:#e8eaf0;">' + esc(g.awayScore) + '</span>' +
          ' <span style="color:#3a4d75;">@</span> ' +
          esc(g.homeAbbr) + ' <span style="color:#e8eaf0;">' + esc(g.homeScore) + '</span>' +
        '</span>' +
        '<span style="font:600 9px/1 ui-monospace,SFMono-Regular,Menlo,monospace;color:' + (focused ? '#22c55e' : '#9aa0a8') + ';letter-spacing:0.12em;">' +
  ...
  function renderOverlay(data) {
    ...
    var pillsHtml = seq.length
      ...
      : '<span style="font:600 11px/1 ui-monospace,SFMono-Regular,Menlo,monospace;color:#9aa0a8;letter-spacing:0.14em;padding:10px 0;">NO PITCHES YET</span>';
    ...
    return (
      '<div class="fc-overlay-card" style="' +
          'width:100%;max-width:520px;background:var(--card,#111827);' +
          'border:1px solid var(--border,#1e2d4a);border-radius:14px;overflow:hidden;' +
        ...
        '<div style="display:flex;align-items:center;gap:10px;padding:14px 18px 10px 18px;">' +
          '<span style="display:inline-flex;align-items:center;gap:6px;font:700 10px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.2em;color:#e03030;">' +
            ...
            'LIVE' +
          '</span>' +
          '<span style="font:600 10px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.16em;color:#9aa0a8;">' +
            halfWord + ' ' + esc(d.inning || '–') +
          '</span>' +
          ...
          '<button type="button" aria-label="Close" onclick="closeFocusOverlay && closeFocusOverlay()" style="' +
              'margin-left:auto;width:30px;height:30px;border-radius:8px;border:1px solid #1e2d4a;' +
              'background:#0a0f1e;color:#9aa0a8;cursor:pointer;font:600 14px/1 ui-monospace,SFMono-Regular,Menlo,monospace;' +
              'display:inline-flex;align-items:center;justify-content:center;' +
            '" onmouseover="this.style.color=\'#e8eaf0\';this.style.borderColor=\'#3a4d75\'"' +
            ' onmouseout="this.style.color=\'#9aa0a8\';this.style.borderColor=\'#1e2d4a\'">✕</button>' +
        '</div>' +
        ...
        '<div style="display:flex;align-items:center;justify-content:space-between;gap:14px;padding:0 18px 14px 18px;">' +
          '<div style="display:flex;align-items:center;gap:12px;">' +
            '<span style="display:inline-flex;align-items:center;justify-content:center;width:46px;height:36px;border-radius:7px;' +
              ...
              'font:700 13px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.06em;color:#e8eaf0;">' +
              esc(d.awayAbbr) +
            '</span>' +
            '<span style="font:600 28px/1 ui-monospace,SFMono-Regular,Menlo,monospace;color:#e8eaf0;' +
          ...
          '</div>' +
          '<span style="font:500 11px/1 ui-monospace,SFMono-Regular,Menlo,monospace;color:#3a4d75;letter-spacing:0.2em;">@</span>' +
          '<div style="display:flex;align-items:center;gap:12px;">' +
            (!awayBatting ? '<span title="batting" style="width:7px;height:7px;border-radius:50%;background:#22c55e;box-shadow:0 0 8px #22c55e;"></span>' : '') +
            '<span style="font:600 28px/1 ui-monospace,SFMono-Regular,Menlo,monospace;color:#e8eaf0;' +
        ...
        '<div style="display:grid;grid-template-columns:1fr 120px;gap:18px;padding:18px;background:#0c1426;border-top:1px solid #1e2d4a;border-bottom:1px solid #1e2d4a;">' +
          ...
          '<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;">' +
            ...
            '<span style="font:700 9px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.18em;color:#9aa0a8;">RUNNERS</span>' +
          '</div>' +
        '</div>' +
        ...
        '<div style="display:grid;grid-template-columns:1fr auto 1fr;gap:14px;align-items:center;padding:16px 18px;">' +
          ...
          '<div style="display:flex;flex-direction:column;gap:8px;min-width:0;">' +
            '<span style="font:700 9px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.18em;color:#9aa0a8;">AT BAT</span>' +
            '<span style="font:600 17px/1.15 ui-sans-serif,system-ui,sans-serif;color:#e8eaf0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">' +
              esc(d.currentBatterName || '—') +
            '</span>' +
          ...
          '<div style="display:flex;flex-direction:column;align-items:center;gap:6px;padding:0 4px;">' +
            '<span style="width:1px;height:18px;background:#1e2d4a;"></span>' +
            '<span style="font:700 9px/1 ui-monospace,SFMono-Regular,Menlo,monospace;color:#3a4d75;letter-spacing:0.2em;">VS</span>' +
            '<span style="width:1px;height:18px;background:#1e2d4a;"></span>' +
          '</div>' +

          // Pitcher
          '<div style="display:flex;flex-direction:column;gap:8px;min-width:0;align-items:flex-end;">' +
            '<span style="font:700 9px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.18em;color:#9aa0a8;">PITCHING</span>' +
            '<span style="font:600 17px/1.15 ui-sans-serif,system-ui,sans-serif;color:#e8eaf0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:right;">' +
              esc(d.currentPitcherName || '—') +
            '</span>' +
        ...
        '<div style="padding:14px 18px 18px 18px;border-top:1px solid #1e2d4a;background:#0a0f1e;">' +
          '<div style="display:flex;align-items:center;gap:10px;margin-bottom:10px;">' +
            '<span style="font:700 10px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.18em;color:#9aa0a8;">PITCH SEQUENCE</span>' +
            '<span style="height:1px;flex:1;background:#1e2d4a;"></span>' +
            '<span style="font:700 10px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0.16em;color:#9aa0a8;">' +
