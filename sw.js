const CACHE = 'mlb-v301'; // bump this version on every deploy to force cache refresh
const SHELL = ['./', './manifest.json', './pulse-card-templates.js', './focusCard.js', './icons/icon-192.png', './icons/icon-512.png'];
