const CACHE = 'mlb-v486'; // bump this version on every deploy to force cache refresh
const SHELL = ['./', './manifest.json', './styles.css', './pulse-redesign.css', './app.js', './pulse-card-templates.js', './focusCard.js', './collectionCard.js', './pulse-redesign.js', './icons/icon-192.png', './icons/icon-512.png'];
