/*! sw.js is mutated by build.mjs — esbuild's `define` substitutes __APP_VERSION__ from package.json. Edit package.json to bump the version, not this constant. */
const CACHE = "mlb-v4.13.1";
